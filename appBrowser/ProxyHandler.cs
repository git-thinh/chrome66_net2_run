namespace appBrowser
{
    ...
    internal sealed class ProxySchemeHandlerFactory : CefSchemeHandlerFactory
    {
        protected override CefResourceHandler Create(CefBrowser browser, CefFrame frame, string schemeName, CefRequest request)
        {
            return new ProxyRequestResourceHandler();
        }
    }
    
    internal sealed class ProxyRequestResourceHandler : CefResourceHandler
    {
